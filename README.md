...
To train the NeRF inpainting codes (for flower scene, for other scenes please check the `configs_inpainting` directory)
```
bash train.sh --config configs_inpainting/flower.txt
```
